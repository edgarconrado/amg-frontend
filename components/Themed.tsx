...
import { Text as DefaultText, View as DefaultView, TextInput as DefaultTextInput, Button as DefaultButton } from 'react-native';
...
export type TextInpputProps = ThemeProps & DefaultTextInput['props'];
